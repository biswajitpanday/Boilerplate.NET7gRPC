...
public static class ExceptionHelpers
{
    public static RpcException Handle<T>(this Exception exception, ServerCallContext context, ILogger<T> logger, Guid correlationId) =>
        exception switch
        {
            ...
            //SqlException sqlException => HandleSqlException(sqlException, context, logger, correlationId),    //todo: Need to uncomment after necessary package install.
    ...
    //todo: Need to uncomment after necessary package install.
